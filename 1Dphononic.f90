!C
!C   program for bulk materials with poroerasticity
...
!       gY1(iter) = (pi2/lY)*dble(iY)
!       gX2(iter) = (pi2/lX)*dble(iX)
!       gY2(iter) = (pi2/lY)*dble(iY)
!     end do
!    end do

  !C  do iter = 1, ng
  !C  write(10, file='lattice.dat') iter, gX1(iter), gY1(iter), gX2(iter), gY2(iter)
  !C  end do
!C===
